        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "End of Watch",    // title
                    2012,       // year
                    "Shot documentary-style, this film follows the daily grind of two young police officers in LA who are partners and friends, and what happens when they meet criminal forces greater than themselves.",     // plot
                    7.7      // rating
                );
