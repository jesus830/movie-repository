    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "The Place Beyond the Pines",    // title
                2012        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Place Beyond the Pines",    // title
                    2012,       // year
                    "A motorcycle stunt rider turns to robbing banks as a way to provide for his lover and their newborn child, a decision that puts him on a collision course with an ambitious rookie cop navigating a department ruled by a corrupt detective.",     // plot
                    7.3      // rating
                );
