        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Expendables 2",    // title
                    2012,       // year
                    "Mr. Church reunites the Expendables for what should be an easy paycheck, but when one of their men is murdered on the job, their quest for revenge puts them deep in enemy territory and up against an unexpected threat.",     // plot
                    6.6      // rating
                );
