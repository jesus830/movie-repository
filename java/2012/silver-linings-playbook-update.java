        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Silver Linings Playbook",    // title
                    2012,       // year
                    "After a stint in a mental institution, former teacher Pat Solitano moves back in with his parents and tries to reconcile with his ex-wife. Things get more challenging when Pat meets Tiffany, a mysterious girl with problems of her own.",     // plot
                    7.8      // rating
                );
