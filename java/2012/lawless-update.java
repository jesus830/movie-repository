        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Lawless",    // title
                    2012,       // year
                    "Set in Depression-era Franklin County, Virginia, a trio of bootlegging brothers are threatened by a new special deputy and other authorities angling for a cut of their profits.",     // plot
                    7.3      // rating
                );
