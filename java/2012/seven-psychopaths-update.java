        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Seven Psychopaths",    // title
                    2012,       // year
                    "A struggling screenwriter inadvertently becomes entangled in the Los Angeles criminal underworld after his oddball friends kidnap a gangster's beloved Shih Tzu.",     // plot
                    7.2      // rating
                );
