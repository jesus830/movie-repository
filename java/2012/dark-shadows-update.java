        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Dark Shadows",    // title
                    2012,       // year
                    "An imprisoned vampire, Barnabas Collins, is set free and returns to his ancestral home, where his dysfunctional descendants are in need of his protection.",     // plot
                    6.2      // rating
                );
