        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Pan's Labyrinth",    // title
                    2006,       // year
                    "In the falangist Spain of 1944, the bookish young stepdaughter of a sadistic army officer escapes into an eerie but captivating fantasy world.",     // plot
                    8.2      // rating
                );
