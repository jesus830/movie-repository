        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "She's the Man",    // title
                    2006,       // year
                    "When her brother decides to ditch for a couple weeks, Viola heads over to his elite boarding school, disguised as him, and proceeds to fall for one of his soccer teammates, and soon learns she's not the only one with romantic troubles.",     // plot
                    6.4      // rating
                );
