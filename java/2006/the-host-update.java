        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Host",    // title
                    2006,       // year
                    "A monster emerges from Seoul's Han River and focuses its attention on attacking people. One victim's loving family does what it can to rescue her from its clutches.",     // plot
                    7      // rating
                );
