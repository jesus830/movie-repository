        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Deja Vu",    // title
                    2006,       // year
                    "After a ferry is bombed in New Orleans, an A.T.F. agent joins a unique investigation using experimental surveillance technology to find the bomber, but soon finds himself becoming obsessed with one of the victims.",     // plot
                    7      // rating
                );
