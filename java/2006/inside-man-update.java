        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Inside Man",    // title
                    2006,       // year
                    "A police detective, a bank robber, and a high-power broker enter high-stakes negotiations after the criminal's brilliant heist spirals into a hostage situation.",     // plot
                    7.6      // rating
                );
