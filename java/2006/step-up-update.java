        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Step Up",    // title
                    2006,       // year
                    "Tyler Gage receives the opportunity of a lifetime after vandalizing a performing arts school, gaining him the chance to earn a scholarship and dance with an up and coming dancer, Nora.",     // plot
                    6.5      // rating
                );
