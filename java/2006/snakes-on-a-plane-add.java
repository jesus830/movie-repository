    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                ...
                2006,       // year
                "An FBI agent takes on a plane full of deadly and venomous snakes, deliberately released to kill a witness being flown from Honolulu to Los Angeles to testify against a mob boss.",     // plot
                5.6      // rating
            );
