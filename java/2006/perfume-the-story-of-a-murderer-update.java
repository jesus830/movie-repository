    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Perfume: The Story of a Murderer",    // title
                2006        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Perfume: The Story of a Murderer",    // title
                    2006,       // year
                    "Jean-Baptiste Grenouille, born with a superior olfactory sense, creates the world's finest perfume. His work, however, takes a dark turn as he searches for the ultimate scent.",     // plot
                    7.5      // rating
                );
