        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "A Good Year",    // title
                    2006,       // year
                    "A British investment broker inherits his uncle's chateau and vineyard in Provence, where he spent much of his childhood. He discovers a new laid-back lifestyle as he tries to renovate the estate to be sold.",     // plot
                    6.9      // rating
                );
