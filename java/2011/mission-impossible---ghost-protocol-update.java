    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Mission: Impossible - Ghost Protocol",    // title
                2011        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Mission: Impossible - Ghost Protocol",    // title
                    2011,       // year
                    "The IMF is shut down when it's implicated in the bombing of the Kremlin, causing Ethan Hunt and his new team to go rogue to clear their organization's name.",     // plot
                    7.4      // rating
                );
