    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Pirates of the Caribbean: On Stranger Tides",    // title
                2011        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Pirates of the Caribbean: On Stranger Tides",    // title
                    2011,       // year
                    "Jack Sparrow and Barbossa embark on a quest to find the elusive fountain of youth, only to discover that Blackbeard and his daughter are after it too.",     // plot
                    6.7      // rating
                );
