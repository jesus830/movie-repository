        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "I Am Number Four",    // title
                    2011,       // year
                    "Aliens and their Guardians are hiding on Earth from intergalactic bounty hunters. They can only be killed in numerical order, and Number Four is next on the list. This is his story.",     // plot
                    6.1      // rating
                );
