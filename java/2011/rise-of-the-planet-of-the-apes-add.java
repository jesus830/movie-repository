    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                "Rise of the Planet of the Apes",    // title
                2011,       // year
                "A substance, designed to help the brain repair itself, gives rise to a super-intelligent chimp who leads an ape uprising.",     // plot
                7.6      // rating
            );
