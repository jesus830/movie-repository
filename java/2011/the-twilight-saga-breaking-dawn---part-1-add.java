    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                "The Twilight Saga: Breaking Dawn - Part 1",    // title
                2011,       // year
                "The Quileutes close in on expecting parents Edward and Bella, whose unborn child poses a threat to the Wolf Pack and the towns people of Forks.",     // plot
                4.9      // rating
            );
