    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Harry Potter and the Deathly Hallows: Part 2",    // title
                2011        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Harry Potter and the Deathly Hallows: Part 2",    // title
                    2011,       // year
                    "Harry, Ron and Hermione search for Voldemort's remaining Horcruxes in their effort to destroy the Dark Lord as the final battle rages on at Hogwarts.",     // plot
                    8.1      // rating
                );
