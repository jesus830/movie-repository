        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Just Go with It",    // title
                    2011,       // year
                    "On a weekend trip to Hawaii, a plastic surgeon convinces his loyal assistant to pose as his soon-to-be-divorced wife in order to cover up a careless lie he told to his much-younger girlfriend.",     // plot
                    6.4      // rating
                );
