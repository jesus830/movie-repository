        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Help",    // title
                    2011,       // year
                    "An aspiring author during the civil rights movement of the 1960s decides to write a book detailing the African American maids' point of view on the white families for which they work, and the hardships they go through on a daily basis.",     // plot
                    8.1      // rating
                );
