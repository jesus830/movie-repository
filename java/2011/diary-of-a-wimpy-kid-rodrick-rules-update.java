    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Diary of a Wimpy Kid: Rodrick Rules",    // title
                2011        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Diary of a Wimpy Kid: Rodrick Rules",    // title
                    2011,       // year
                    "Back in middle school after summer vacation, Greg Heffley and his older brother Rodrick must deal with their parents' misguided attempts to have them bond.",     // plot
                    6.6      // rating
                );
