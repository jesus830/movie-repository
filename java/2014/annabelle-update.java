        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Annabelle",    // title
                    2014,       // year
                    "A couple begins to experience terrifying supernatural occurrences involving a vintage doll shortly after their home is invaded by satanic cultists.",     // plot
                    5.4      // rating
                );
