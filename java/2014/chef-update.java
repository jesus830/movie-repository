        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Chef",    // title
                    2014,       // year
                    "A head chef quits his restaurant job and buys a food truck in an effort to reclaim his creative promise, while piecing back together his estranged family.",     // plot
                    7.3      // rating
                );
