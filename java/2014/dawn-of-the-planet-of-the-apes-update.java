        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Dawn of the Planet of the Apes",    // title
                    2014,       // year
                    "A growing nation of genetically evolved apes led by Caesar is threatened by a band of human survivors of the devastating virus unleashed a decade earlier.",     // plot
                    7.6      // rating
                );
