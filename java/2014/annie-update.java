        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Annie",    // title
                    2014,       // year
                    "A foster kid, who lives with her mean foster mom, sees her life change when business tycoon and New York mayoral candidate Will Stacks makes a thinly-veiled campaign move and takes her in.",     // plot
                    5.3      // rating
                );
