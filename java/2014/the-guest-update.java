        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Guest",    // title
                    2014,       // year
                    "A soldier introduces himself to the Peterson family, claiming to be a friend of their son who died in action. After the young man is welcomed into their home, a series of accidental deaths seem to be connected to his presence.",     // plot
                    6.7      // rating
                );
