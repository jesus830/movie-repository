        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Expendables 3",    // title
                    2014,       // year
                    "Barney augments his team with new blood for a personal battle: to take down Conrad Stonebanks, the Expendables co-founder and notorious arms trader who is hell bent on wiping out Barney and every single one of his associates.",     // plot
                    6.1      // rating
                );
