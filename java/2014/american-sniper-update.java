        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "American Sniper",    // title
                    2014,       // year
                    "Navy S.E.A.L. sniper Chris Kyle's pinpoint accuracy saves countless lives on the battlefield and turns him into a legend. Back home to his wife and kids after four tours of duty, however, Chris finds that it is the war he can't leave behind.",     // plot
                    7.3      // rating
                );
