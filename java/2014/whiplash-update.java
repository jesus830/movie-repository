        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Whiplash",    // title
                    2014,       // year
                    "A promising young drummer enrolls at a cut-throat music conservatory where his dreams of greatness are mentored by an instructor who will stop at nothing to realize a student's potential.",     // plot
                    8.5      // rating
                );
