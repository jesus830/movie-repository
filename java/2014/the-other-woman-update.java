        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Other Woman",    // title
                    2014,       // year
                    "After discovering her boyfriend is married, Carly soon meets the wife he's been betraying. And when yet another love affair is discovered, all three women team up to plot revenge on the three-timing S.O.B.",     // plot
                    6      // rating
                );
