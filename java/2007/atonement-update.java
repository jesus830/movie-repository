        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Atonement",    // title
                    2007,       // year
                    "Fledgling writer Briony Tallis, as a thirteen-year-old, irrevocably changes the course of several lives when she accuses her older sister's lover of a crime he did not commit.",     // plot
                    7.8      // rating
                );
