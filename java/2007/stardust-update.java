        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Stardust",    // title
                    2007,       // year
                    "In a countryside town bordering on a magical land, a young man makes a promise to his beloved that he'll retrieve a fallen star by venturing into the magical realm.",     // plot
                    7.7      // rating
                );
