        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "28 Weeks Later",    // title
                    2007,       // year
                    "Six months after the rage virus was inflicted on the population of Great Britain, the US Army helps to secure a small area of London for the survivors to repopulate and start again. But not everything goes to plan.",     // plot
                    7      // rating
                );
