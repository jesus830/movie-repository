        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "I Am Legend",    // title
                    2007,       // year
                    "Years after a plague kills most of humanity and transforms the rest into monsters, the sole survivor in New York City struggles valiantly to find a cure.",     // plot
                    7.2      // rating
                );
