    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "The Assassination of Jesse James by the Coward Robert Ford",    // title
                2007        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Assassination of Jesse James by the Coward Robert Ford",    // title
                    2007,       // year
                    "Robert Ford, who's idolized Jesse James since childhood, tries hard to join the reforming gang of the Missouri outlaw, but gradually becomes resentful of the bandit leader.",     // plot
                    7.5      // rating
                );
