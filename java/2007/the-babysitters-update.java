        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Babysitters",    // title
                    2007,       // year
                    "A teenager turns her babysitting service into a call-girl service for married guys after fooling around with one of her customers.",     // plot
                    5.7      // rating
                );
