    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Sweeney Todd: The Demon Barber of Fleet Street",    // title
                2007        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Sweeney Todd: The Demon Barber of Fleet Street",    // title
                    2007,       // year
                    "The infamous story of Benjamin Barker, a.k.a. Sweeney Todd, who sets up a barber shop down in London which is the basis for a sinister partnership with his fellow tenant, Mrs. Lovett. Based on the hit Broadway musical.",     // plot
                    7.4      // rating
                );
