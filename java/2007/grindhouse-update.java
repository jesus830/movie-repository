        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Grindhouse",    // title
                    2007,       // year
                    "Quentin Tarantino and Robert Rodriguez's homage to exploitation double features in the 60s and 70s with two back-to-back cult films that include previews of coming attractions between them.",     // plot
                    7.6      // rating
                );
