        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Harry Potter and the Order of the Phoenix",    // title
                    2007,       // year
                    "With their warning about Lord Voldemort's return scoffed at, Harry and Dumbledore are targeted by the Wizard authorities as an authoritarian bureaucrat slowly seizes power at Hogwarts.",     // plot
                    7.5      // rating
                );
