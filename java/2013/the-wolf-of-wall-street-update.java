        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Wolf of Wall Street",    // title
                    2013,       // year
                    "Based on the true story of Jordan Belfort, from his rise to a wealthy stock-broker living the high life to his fall involving crime, corruption and the federal government.",     // plot
                    8.2      // rating
                );
