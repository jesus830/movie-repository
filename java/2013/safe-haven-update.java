        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Safe Haven",    // title
                    2013,       // year
                    "A young woman with a mysterious past lands in Southport, North Carolina where her bond with a widower forces her to confront the dark secret that haunts her.",     // plot
                    6.7      // rating
                );
