        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "This Is the End",    // title
                    2013,       // year
                    "While attending a party at James Franco's house, Seth Rogen, Jay Baruchel and many other celebrities are faced with the Biblical Apocalypse.",     // plot
                    6.6      // rating
                );
