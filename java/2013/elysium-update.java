        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Elysium",    // title
                    2013,       // year
                    "In the year 2154, the very wealthy live on a man-made space station while the rest of the population resides on a ruined Earth. A man takes on a mission that could bring equality to the polarized worlds.",     // plot
                    6.6      // rating
                );
