        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Evil Dead",    // title
                    2013,       // year
                    "Five friends head to a remote cabin, where the discovery of a Book of the Dead leads them to unwittingly summon up demons living in the nearby woods.",     // plot
                    6.5      // rating
                );
