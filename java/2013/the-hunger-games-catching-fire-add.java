    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                ...
                2013,       // year
                "Katniss Everdeen and Peeta Mellark become targets of the Capitol after their victory in the 74th Hunger Games sparks a rebellion in the Districts of Panem.",     // plot
                7.6      // rating
            );
