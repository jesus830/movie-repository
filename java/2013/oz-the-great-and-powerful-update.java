    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Oz the Great and Powerful",    // title
                2013        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Oz the Great and Powerful",    // title
                    2013,       // year
                    "A frustrated circus magician from Kansas is transported to a magical land called Oz, where he will have to fulfill a prophecy to become the king, and release the land from the Wicked Witches using his great (but fake) powers.",     // plot
                    6.3      // rating
                );
