        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Dallas Buyers Club",    // title
                    2013,       // year
                    "In 1985 Dallas, electrician and hustler Ron Woodroof works around the system to help AIDS patients get the medication they need after he is diagnosed with the disease.",     // plot
                    8      // rating
                );
