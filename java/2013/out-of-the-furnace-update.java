        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Out of the Furnace",    // title
                    2013,       // year
                    "When Rodney Baze mysteriously disappears and law enforcement doesn't follow through fast enough, his older brother, Russell, takes matters into his own hands to find justice.",     // plot
                    6.8      // rating
                );
