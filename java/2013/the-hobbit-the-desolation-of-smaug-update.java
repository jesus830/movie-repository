    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "The Hobbit: The Desolation of Smaug",    // title
                2013        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Hobbit: The Desolation of Smaug",    // title
                    2013,       // year
                    "The dwarves, along with Bilbo Baggins and Gandalf the Grey, continue their quest to reclaim Erebor, their homeland, from Smaug. Bilbo Baggins is in possession of a mysterious and magical ring.",     // plot
                    7.9      // rating
                );
