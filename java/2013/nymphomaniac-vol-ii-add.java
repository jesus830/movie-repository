    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                "Nymphomaniac: Vol. II",    // title
                2013,       // year
                "The continuation of Joe's sexually dictated life delves into the darker aspects of her adulthood, obsessions and what led to her being in Seligman's care.",     // plot
                6.7      // rating
            );
