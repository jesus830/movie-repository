        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Olympus Has Fallen",    // title
                    2013,       // year
                    "Disgraced Secret Service agent (and former presidential guard) Mike Banning finds himself trapped inside the White House in the wake of a terrorist attack; using his inside knowledge, Banning works with national security to rescue the President from his kidnappers.",     // plot
                    6.5      // rating
                );
