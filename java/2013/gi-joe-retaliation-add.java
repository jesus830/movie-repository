    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                "G.I. Joe: Retaliation",    // title
                2013,       // year
                "The G.I. Joes are not only fighting their mortal enemy Cobra; they are forced to contend with threats from within the government that jeopardize their very existence.",     // plot
                5.8      // rating
            );
