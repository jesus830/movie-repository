        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Mr. Church",    // title
                    2016,       // year
                    "'Mr. Church' tells the story of a unique friendship that develops when a little girl and her dying mother retain the services of a talented cook - Henry Joseph Church. What begins as a six month arrangement instead spans into fifteen years and creates a family bond that lasts forever.",     // plot
                    7.7      // rating
                );
