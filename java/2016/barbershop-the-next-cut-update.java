        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Barbershop: The Next Cut",    // title
                    2016,       // year
                    "As their surrounding community has taken a turn for the worse, the crew at Calvin's Barbershop come together to bring some much needed change to their neighborhood.",     // plot
                    5.9      // rating
                );
