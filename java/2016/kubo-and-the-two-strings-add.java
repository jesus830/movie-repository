    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                "Kubo and the Two Strings",    // title
                2016,       // year
                "A young boy named Kubo must locate a magical suit of armour worn by his late father in order to defeat a vengeful spirit from the past.",     // plot
                7.9      // rating
            );
