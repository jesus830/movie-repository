        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Thinning",    // title
                    2016,       // year
                    "'The Thinning' takes place in a post-apocalyptic future where population control is dictated by a high-school aptitude test. When two students (Logan Paul and Peyton List) discover the test... See full summary »",     // plot
                    6      // rating
                );
