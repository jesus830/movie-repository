        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The 5th Wave",    // title
                    2016,       // year
                    "Four waves of increasingly deadly alien attacks have left most of Earth decimated. Cassie is on the run, desperately trying to save her younger brother.",     // plot
                    5.2      // rating
                );
