        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Conjuring 2",    // title
                    2016,       // year
                    "Lorraine and Ed Warren travel to north London to help a single mother raising four children alone in a house plagued by a malicious spirit.",     // plot
                    7.4      // rating
                );
