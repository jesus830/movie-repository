        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Masterminds",    // title
                    2016,       // year
                    "A guard at an armored car company in the Southern U.S. organizes one of the biggest bank heists in American history. Based on the October 1997 Loomis Fargo robbery.",     // plot
                    5.8      // rating
                );
