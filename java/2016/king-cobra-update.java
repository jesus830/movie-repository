        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "King Cobra",    // title
                    2016,       // year
                    "This ripped-from-the-headlines drama covers the early rise of gay porn headliner Sean Paul Lockhart a.k.a. Brent Corrigan, before his falling out with the producer who made him famous. When... See full summary »",     // plot
                    5.6      // rating
                );
