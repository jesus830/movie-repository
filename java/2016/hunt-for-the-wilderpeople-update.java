    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Hunt for the Wilderpeople",    // title
                2016        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Hunt for the Wilderpeople",    // title
                    2016,       // year
                    "A national manhunt is ordered for a rebellious kid and his foster uncle who go missing in the wild New Zealand bush.",     // plot
                    7.9      // rating
                );
