        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Criminal",    // title
                    2016,       // year
                    "In a last-ditch effort to stop a diabolical plot, a dead CIA operative's memories, secrets, and skills are implanted into a death-row inmate in hopes that he will complete the operative's mission.",     // plot
                    6.3      // rating
                );
