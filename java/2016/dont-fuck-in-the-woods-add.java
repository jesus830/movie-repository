    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                "Don't Fuck in the Woods",    // title
                2016,       // year
                "A group of friends are going on a camping trip to celebrate graduating college. But once they enter the woods, the proverbial shit starts to hit the fan.",     // plot
                2.7      // rating
            );
