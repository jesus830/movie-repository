    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "The Girl with All the Gifts",    // title
                2016        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Girl with All the Gifts",    // title
                    2016,       // year
                    "A scientist and a teacher living in a dystopian future embark on a journey of survival with a special young girl named Melanie.",     // plot
                    6.7      // rating
                );
