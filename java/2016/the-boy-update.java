        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Boy",    // title
                    2016,       // year
                    "An American nanny is shocked that her new English family's boy is actually a life-sized doll. After she violates a list of strict rules, disturbing events make her believe that the doll is really alive.",     // plot
                    6      // rating
                );
