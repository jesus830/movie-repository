        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Ma vie de Courgette",    // title
                    2016,       // year
                    "After losing his mother, a young boy is sent to a foster home with other orphans his age where he begins to learn the meaning of trust and true love.",     // plot
                    7.8      // rating
                );
