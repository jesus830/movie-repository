    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Popstar: Never Stop Never Stopping",    // title
                2016        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Popstar: Never Stop Never Stopping",    // title
                    2016,       // year
                    "When it becomes clear that his solo album is a failure, a former boy band member does everything in his power to maintain his celebrity status.",     // plot
                    6.7      // rating
                );
