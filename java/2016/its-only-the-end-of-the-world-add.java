    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                "It's Only the End of the World",    // title
                2016,       // year
                "Louis (Gaspard Ulliel), a terminally ill writer, returns home after a long absence to tell his family that he is dying.",     // plot
                7      // rating
            );
