        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Chalk It Up",    // title
                    2016,       // year
                    "When a super girly-girl is dumped by her boyfriend; she decides to do everything she can to get him back by building a college gymnastics team, quickly learning that she is capable of a lot more than just getting an MRS degree.",     // plot
                    4.8      // rating
                );
