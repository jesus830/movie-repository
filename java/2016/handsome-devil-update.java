        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Handsome Devil",    // title
                    2016,       // year
                    "Ned and Conor are forced to share a bedroom at their boarding school. The loner and the star athlete at this rugby-mad school form an unlikely friendship until it's tested by the authorities.",     // plot
                    7.4      // rating
                );
