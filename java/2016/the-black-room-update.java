        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Black Room",    // title
                    2016,       // year
                    "PAUL and JENNIFER HEMDALE have just moved into their dream house. But their happy marriage is about to be put to the test as they slowly discover the secret behind the black room in the ... See full summary »",     // plot
                    3.9      // rating
                );
