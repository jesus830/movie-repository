    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Mike and Dave Need Wedding Dates",    // title
                2016        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Mike and Dave Need Wedding Dates",    // title
                    2016,       // year
                    "Two hard-partying brothers place an online ad to find the perfect dates for their sister's Hawaiian wedding. Hoping for a wild getaway, the boys instead find themselves out-hustled by an uncontrollable duo.",     // plot
                    6      // rating
                );
