        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The BFG",    // title
                    2016,       // year
                    "An orphan little girl befriends a benevolent giant who takes her to Giant Country, where they attempt to stop the man-eating giants that are invading the human world.",     // plot
                    6.4      // rating
                );
