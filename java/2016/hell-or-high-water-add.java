    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                "Hell or High Water",    // title
                2016,       // year
                "A divorced father and his ex-con older brother resort to a desperate scheme in order to save their family's ranch in West Texas.",     // plot
                7.7      // rating
            );
