    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                ...
                2016,       // year
                "A personal shopper in Paris refuses to leave the city until she makes contact with her twin brother who previously died there. Her life becomes more complicated when a mysterious person contacts her via text message.",     // plot
                6.3      // rating
            );
