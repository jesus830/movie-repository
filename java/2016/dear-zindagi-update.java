        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Dear Zindagi",    // title
                    2016,       // year
                    "Kaira is a budding cinematographer in search of a perfect life. Her encounter with Jug, an unconventional thinker, helps her gain a new perspective on life. She discovers that happiness is all about finding comfort in life's imperfections.",     // plot
                    7.8      // rating
                );
