        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Viking",    // title
                    2016,       // year
                    "Kievan Rus, late 10th century. After the death of his father, the young Viking prince Vladimir of Novgorod is forced into exile across the frozen sea.",     // plot
                    4.7      // rating
                );
