        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Birth of the Dragon",    // title
                    2016,       // year
                    "Young, up-and-coming martial artist, Bruce Lee, challenges legendary kung fu master Wong Jack Man to a no-holds-barred fight in Northern California.",     // plot
                    3.9      // rating
                );
