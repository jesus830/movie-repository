    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Billy Lynn's Long Halftime Walk",    // title
                2016        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Billy Lynn's Long Halftime Walk",    // title
                    2016,       // year
                    "19-year-old Billy Lynn is brought home for a victory tour after a harrowing Iraq battle. Through flashbacks the film shows what really happened to his squad - contrasting the realities of war with America's perceptions.",     // plot
                    6.3      // rating
                );
