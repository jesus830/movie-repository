        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Below Her Mouth",    // title
                    2016,       // year
                    "An unexpected affair quickly escalates into a heart-stopping reality for two women whose passionate connection changes their lives forever.",     // plot
                    5.6      // rating
                );
