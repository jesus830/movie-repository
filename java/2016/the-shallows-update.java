        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Shallows",    // title
                    2016,       // year
                    "A mere 200 yards from shore, surfer Nancy is attacked by a great white shark, with her short journey to safety becoming the ultimate contest of wills.",     // plot
                    6.4      // rating
                );
