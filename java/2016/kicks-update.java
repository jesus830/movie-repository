        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Kicks",    // title
                    2016,       // year
                    "Brandon is a 15 year old whose dream is a pair of fresh Air Jordans. Soon after he gets his hands on them, they're stolen by a local hood, causing Brandon and his two friends to go on a dangerous mission through Oakland to retrieve them.",     // plot
                    6.1      // rating
                );
