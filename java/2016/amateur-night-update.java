        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Amateur Night",    // title
                    2016,       // year
                    "Guy Carter is an award-winning graduate student of architecture. He's got a beautiful wife and a baby on the way. The problem? He doesn't have 'his ducks in a row,' which only fuels his ... See full summary »",     // plot
                    5      // rating
                );
