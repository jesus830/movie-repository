        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Boyka: Undisputed IV",    // title
                    2016,       // year
                    "In the fourth installment of the fighting franchise, Boyka is shooting for the big leagues when an accidental death in the ring makes him question everything he stands for.",     // plot
                    7.4      // rating
                );
