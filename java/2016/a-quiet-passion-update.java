        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "A Quiet Passion",    // title
                    2016,       // year
                    "The story of American poet Emily Dickinson from her early days as a young schoolgirl to her later years as a reclusive, unrecognized artist.",     // plot
                    7.2      // rating
                );
