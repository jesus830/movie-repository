        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Moana",    // title
                    2016,       // year
                    "In Ancient Polynesia, when a terrible curse incurred by the Demigod Maui reaches an impetuous Chieftain's daughter's island, she answers the Ocean's call to seek out the Demigod to set things right.",     // plot
                    7.7      // rating
                );
