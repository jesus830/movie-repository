    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Jack Reacher: Never Go Back",    // title
                2016        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Jack Reacher: Never Go Back",    // title
                    2016,       // year
                    "Jack Reacher must uncover the truth behind a major government conspiracy in order to clear his name. On the run as a fugitive from the law, Reacher uncovers a potential secret from his past that could change his life forever.",     // plot
                    6.1      // rating
                );
