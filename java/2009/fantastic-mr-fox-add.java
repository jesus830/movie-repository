    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                "Fantastic Mr. Fox",    // title
                2009,       // year
                "An urbane fox cannot resist returning to his farm raiding ways and then must help his community survive the farmers' retaliation.",     // plot
                7.8      // rating
            );
