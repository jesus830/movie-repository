    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                "He's Just Not That Into You",    // title
                2009,       // year
                "The Baltimore-set movie of interconnecting story arcs deals with the challenges of reading or misreading human behavior.",     // plot
                6.4      // rating
            );
