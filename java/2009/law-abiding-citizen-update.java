        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Law Abiding Citizen",    // title
                    2009,       // year
                    "A frustrated man decides to take justice into his own hands after a plea bargain sets one of his family's killers free. He targets not only the killer but also the district attorney and others involved in the deal.",     // plot
                    7.4      // rating
                );
