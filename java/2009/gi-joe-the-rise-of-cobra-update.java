    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "G.I. Joe: The Rise of Cobra",    // title
                2009        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "G.I. Joe: The Rise of Cobra",    // title
                    2009,       // year
                    "An elite military unit comprised of special operatives known as G.I. Joe, operating out of The Pit, takes on an evil organization led by a notorious arms dealer.",     // plot
                    5.8      // rating
                );
