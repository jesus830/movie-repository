        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Moon",    // title
                    2009,       // year
                    "Astronaut Sam Bell has a quintessentially personal encounter toward the end of his three-year stint on the Moon, where he, working alongside his computer, GERTY, sends back to Earth parcels of a resource that has helped diminish our planet's power problems.",     // plot
                    7.9      // rating
                );
