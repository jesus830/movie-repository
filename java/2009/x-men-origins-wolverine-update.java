        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "X-Men Origins: Wolverine",    // title
                    2009,       // year
                    "A look at Wolverine's early life, in particular his time with the government squad Team X and the impact it will have on his later years.",     // plot
                    6.7      // rating
                );
