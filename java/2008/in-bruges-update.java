        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "In Bruges",    // title
                    2008,       // year
                    "Guilt-stricken after a job gone wrong, hitman Ray and his partner await orders from their ruthless boss in Bruges, Belgium, the last place in the world Ray wants to be.",     // plot
                    7.9      // rating
                );
