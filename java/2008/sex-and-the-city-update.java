        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Sex and the City",    // title
                    2008,       // year
                    "A New York writer on sex and love is finally getting married to her Mr. Big. But her three best girlfriends must console her after one of them inadvertently leads Mr. Big to jilt her.",     // plot
                    5.5      // rating
                );
