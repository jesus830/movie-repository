        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Slumdog Millionaire",    // title
                    2008,       // year
                    "A Mumbai teen reflects on his upbringing in the slums when he is accused of cheating on the Indian Version of 'Who Wants to be a Millionaire?'",     // plot
                    8      // rating
                );
