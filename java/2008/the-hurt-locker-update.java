        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Hurt Locker",    // title
                    2008,       // year
                    "During the Iraq War, a Sergeant recently assigned to an army bomb squad is put at odds with his squad mates due to his maverick way of handling his work.",     // plot
                    7.6      // rating
                );
