        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Changeling",    // title
                    2008,       // year
                    "A grief-stricken mother takes on the LAPD to her own detriment when it stubbornly tries to pass off an obvious impostor as her missing child, while also refusing to give up hope that she will find him one day.",     // plot
                    7.8      // rating
                );
