        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Revolutionary Road",    // title
                    2008,       // year
                    "A young couple living in a Connecticut suburb during the mid-1950s struggle to come to terms with their personal problems while trying to raise their two children.",     // plot
                    7.3      // rating
                );
