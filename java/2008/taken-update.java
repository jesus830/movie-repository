        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Taken",    // title
                    2008,       // year
                    "A retired CIA agent travels across Europe and relies on his old skills to save his estranged daughter, who has been kidnapped while on a trip to Paris.",     // plot
                    7.8      // rating
                );
