        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Disaster Movie",    // title
                    2008,       // year
                    "Over the course of one evening, an unsuspecting group of twenty-somethings find themselves bombarded by a series of natural disasters and catastrophic events.",     // plot
                    1.9      // rating
                );
