        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Inception",    // title
                    2010,       // year
                    "A thief, who steals corporate secrets through use of dream-sharing technology, is given the inverse task of planting an idea into the mind of a CEO.",     // plot
                    8.8      // rating
                );
