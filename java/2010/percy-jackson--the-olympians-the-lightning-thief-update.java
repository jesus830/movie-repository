    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Percy Jackson & the Olympians: The Lightning Thief",    // title
                2010        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Percy Jackson & the Olympians: The Lightning Thief",    // title
                    2010,       // year
                    "A teenager discovers he's the descendant of a Greek god and sets out on an adventure to settle an on-going battle between the gods.",     // plot
                    5.9      // rating
                );
