    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                "The Ghost Writer",    // title
                2010,       // year
                "A ghostwriter hired to complete the memoirs of a former British prime minister uncovers secrets that put his own life in jeopardy.",     // plot
                7.2      // rating
            );
