    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                "Prince of Persia: The Sands of Time",    // title
                2010,       // year
                "A young fugitive prince and princess must stop a villain who unknowingly threatens to destroy the world with a special dagger that enables the magic sand inside to reverse time.",     // plot
                6.6      // rating
            );
