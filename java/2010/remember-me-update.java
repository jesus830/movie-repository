        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Remember Me",    // title
                    2010,       // year
                    "A romantic drama centered on two new lovers: Tyler, whose parents have split in the wake of his brother's suicide, and Ally, who lives each day to the fullest since witnessing her mother's murder.",     // plot
                    7.2      // rating
                );
