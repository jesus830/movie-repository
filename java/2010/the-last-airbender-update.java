        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Last Airbender",    // title
                    2010,       // year
                    "Follows the adventures of Aang, a young successor to a long line of Avatars, who must master all four elements and stop the Fire Nation from enslaving the Water Tribes and the Earth Kingdom.",     // plot
                    4.2      // rating
                );
