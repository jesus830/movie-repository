    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean success = movies.insert(
                ...
                2010,       // year
                "Nineteen-year-old Alice returns to the magical world from her childhood adventure, where she reunites with her old friends and learns of her true destiny: to end the Red Queen's reign of terror.",     // plot
                6.5      // rating
            );
