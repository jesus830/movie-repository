        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Big Short",    // title
                    2015,       // year
                    "Four denizens in the world of high-finance predict the credit and housing bubble collapse of the mid-2000s, and decide to take on the big banks for their greed and lack of foresight.",     // plot
                    7.8      // rating
                );
