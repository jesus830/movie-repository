        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Southpaw",    // title
                    2015,       // year
                    "Boxer Billy Hope turns to trainer Tick Wills to help him get his life back on track after losing his wife in a tragic accident and his daughter to child protection services.",     // plot
                    7.4      // rating
                );
