        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Pan",    // title
                    2015,       // year
                    "12-year-old orphan Peter is spirited away to the magical world of Neverland, where he finds both fun and danger, and ultimately discovers his destiny -- to become the hero who will be forever known as Peter Pan.",     // plot
                    5.8      // rating
                );
