        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Colonia",    // title
                    2015,       // year
                    "A young woman's desperate search for her abducted boyfriend that draws her into the infamous Colonia Dignidad, a sect nobody has ever escaped from.",     // plot
                    7.1      // rating
                );
