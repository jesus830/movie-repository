        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Black Mass",    // title
                    2015,       // year
                    "The true story of Whitey Bulger, the brother of a state senator and the most infamous violent criminal in the history of South Boston, who became an FBI informant to take down a Mafia family invading his turf.",     // plot
                    6.9      // rating
                );
