        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Crimson Peak",    // title
                    2015,       // year
                    "In the aftermath of a family tragedy, an aspiring author is torn between love for her childhood friend and the temptation of a mysterious outsider. Trying to escape the ghosts of her past, she is swept away to a house that breathes, bleeds - and remembers.",     // plot
                    6.6      // rating
                );
