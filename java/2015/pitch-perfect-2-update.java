        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Pitch Perfect 2",    // title
                    2015,       // year
                    "After a humiliating command performance at The Kennedy Center, the Barden Bellas enter an international competition that no American group has ever won in order to regain their status and right to perform.",     // plot
                    6.5      // rating
                );
