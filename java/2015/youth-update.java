        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Youth",    // title
                    2015,       // year
                    "A retired orchestra conductor is on holiday with his daughter and his film director best friend in the Alps when he receives an invitation from Queen Elizabeth II to perform for Prince Philip's birthday.",     // plot
                    7.3      // rating
                );
