        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Ridiculous 6",    // title
                    2015,       // year
                    "An outlaw who was raised by Native Americans discovers that he has five half-brothers; together the men go on a mission to find their wayward, deadbeat dad.",     // plot
                    4.8      // rating
                );
