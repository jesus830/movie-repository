        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "No Escape",    // title
                    2015,       // year
                    "In their new overseas home, an American family soon finds themselves caught in the middle of a coup, and they frantically look for a safe escape from an environment where foreigners are being immediately executed.",     // plot
                    6.8      // rating
                );
