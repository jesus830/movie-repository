        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "The Rise of the Krays",    // title
                    2015,       // year
                    "Two brothers unleash a psychotic reign of terror on their journey to build an empire of unprecedented power in the British Mafia.",     // plot
                    5.1      // rating
                );
