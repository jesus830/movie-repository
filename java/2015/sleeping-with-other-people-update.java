    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Sleeping with Other People",    // title
                2015        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Sleeping with Other People",    // title
                    2015,       // year
                    "A good-natured womanizer and a serial cheater form a platonic relationship that helps reform them in ways, while a mutual attraction sets in.",     // plot
                    6.5      // rating
                );
