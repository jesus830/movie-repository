        ...
        try {
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Point Break",    // title
                    2015,       // year
                    "A young FBI agent infiltrates an extraordinary team of extreme sports athletes he suspects of masterminding a string of unprecedented, sophisticated corporate heists.",     // plot
                    5.3      // rating
                );
