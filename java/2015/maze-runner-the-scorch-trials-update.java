    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Movie movie = movies.select(
                "Maze Runner: The Scorch Trials",    // title
                2015        // year
            );
            ...
            if (movie != null) {
                ...
                boolean success = movies.update(
                    "Maze Runner: The Scorch Trials",    // title
                    2015,       // year
                    "After having escaped the Maze, the Gladers now face a new set of challenges on the open roads of a desolate landscape filled with unimaginable obstacles.",     // plot
                    6.3      // rating
                );
