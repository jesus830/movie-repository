...
class MovieRepository:
    ...
    def __init__(self, dyn_resource=None, table_name=None):
        """
    ...
    def insert(self, title, year, plot, rating):
        """
    ...
    def update(self, title, year, plot, rating):
        """
