...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Zodiac",    // title
            2007,       // year
            "In the late 1960s/early 1970s, a San Francisco cartoonist becomes an amateur detective obsessed with tracking down the Zodiac Killer, an unidentified individual who terrorizes Northern California with a killing spree.",     // plot
            7.7      // rating
        );
