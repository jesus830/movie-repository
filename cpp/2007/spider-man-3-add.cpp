...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Spider-Man 3",    // title
            2007,       // year
            "A strange black entity from another world bonds with Peter Parker and causes inner turmoil as he contends with new villains, temptations, and revenge.",     // plot
            6.2      // rating
        );
