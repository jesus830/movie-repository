...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Pirates of the Caribbean: At World's End",    // title
            2007,       // year
            "Captain Barbossa, Will Turner and Elizabeth Swann must sail off the edge of the map, navigate treachery and betrayal, find Jack Sparrow, and make their final alliances for one last decisive battle.",     // plot
            7.1      // rating
        );
