    ...
    
    {
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Freedom Writers",    // title
                2007,       // year
                "A young teacher inspires her class of at-risk students to learn tolerance, apply themselves, and pursue education beyond high school.",     // plot
                7.5      // rating
            );
