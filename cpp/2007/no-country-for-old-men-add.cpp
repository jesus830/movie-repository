...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "No Country for Old Men",    // title
            2007,       // year
            "Violence and mayhem ensue after a hunter stumbles upon a drug deal gone wrong and more than two million dollars in cash near the Rio Grande.",     // plot
            8.1      // rating
        );
