...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "The Hunger Games: Mockingjay - Part 2",    // title
            2015        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "The Hunger Games: Mockingjay - Part 2",    // title
                2015,       // year
                "As the war of Panem escalates to the destruction of other districts, Katniss Everdeen, the reluctant leader of the rebellion, must bring together an army against President Snow, while all she holds dear hangs in the balance.",     // plot
                6.6      // rating
            );
