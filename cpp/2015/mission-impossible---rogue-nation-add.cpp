...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Mission: Impossible - Rogue Nation",    // title
            2015,       // year
            "Ethan and team take on their most impossible mission yet, eradicating the Syndicate - an International rogue organization as highly skilled as they are, committed to destroying the IMF.",     // plot
            7.4      // rating
        );
