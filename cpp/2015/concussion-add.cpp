...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Concussion",    // title
            2015,       // year
            "In Pittsburgh, accomplished pathologist Dr. Bennet Omalu uncovers the truth about brain damage in football players who suffer repeated concussions in the course of normal play.",     // plot
            7.1      // rating
        );
