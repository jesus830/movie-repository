...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Knock Knock",    // title
            2015,       // year
            "A devoted father helps two stranded young women who knock on his door, but his kind gesture turns into a dangerous seduction and a deadly game of cat and mouse.",     // plot
            4.9      // rating
        );
