...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Daddy's Home",    // title
            2015,       // year
            "Brad Whitaker is a radio host trying to get his stepchildren to love him and call him Dad. But his plans turn upside down when their biological father, Dusty Mayron, returns.",     // plot
            6.1      // rating
        );
