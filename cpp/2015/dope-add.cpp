...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Dope",    // title
            2015,       // year
            "Life changes for Malcolm, a geek who's surviving life in a tough neighborhood, after a chance invitation to an underground party leads him and his friends into a Los Angeles adventure.",     // plot
            7.3      // rating
        );
