...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Magic Mike XXL",    // title
            2015,       // year
            "Three years after Mike bowed out of the stripper life at the top of his game, he and the remaining Kings of Tampa hit the road to Myrtle Beach to put on one last blow-out performance.",     // plot
            5.7      // rating
        );
