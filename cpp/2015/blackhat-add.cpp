...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Blackhat",    // title
            2015,       // year
            "A furloughed convict and his American and Chinese partners hunt a high-level cybercrime network from Chicago to Los Angeles to Hong Kong to Jakarta.",     // plot
            5.4      // rating
        );
