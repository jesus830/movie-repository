    ...
    
    {
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Hotel Transylvania 2",    // title
                2015,       // year
                "Dracula and his friends try to bring out the monster in his half human, half vampire grandson in order to keep Mavis from leaving the hotel.",     // plot
                6.7      // rating
            );
