...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "The Stanford Prison Experiment",    // title
            2015        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "The Stanford Prison Experiment",    // title
                2015,       // year
                "Twenty-four male students out of seventy-five were selected to take on randomly assigned roles of prisoners and guards in a mock prison situated in the basement of the Stanford psychology building.",     // plot
                6.9      // rating
            );
