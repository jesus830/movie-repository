...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "The Martian",    // title
            2015,       // year
            "An astronaut becomes stranded on Mars after his team assume him dead, and must rely on his ingenuity to find a way to signal to Earth that he is alive.",     // plot
            8      // rating
        );
