...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Straight Outta Compton",    // title
            2015,       // year
            "The group NWA emerges from the mean streets of Compton in Los Angeles, California, in the mid-1980s and revolutionizes Hip Hop culture with their music and tales about life in the hood.",     // plot
            7.9      // rating
        );
