...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Underworld: Blood Wars",    // title
            2016,       // year
            "Vampire death dealer, Selene (Kate Beckinsale) fights to end the eternal war between the Lycan clan and the Vampire faction that betrayed her.",     // plot
            5.8      // rating
        );
