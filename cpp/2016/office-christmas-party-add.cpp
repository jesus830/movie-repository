...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Office Christmas Party",    // title
            2016,       // year
            "When his uptight CEO sister threatens to shut down his branch, the branch manager throws an epic Christmas party in order to land a big client and save the day, but the party gets way out of hand...",     // plot
            5.8      // rating
        );
