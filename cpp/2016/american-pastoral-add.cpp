...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "American Pastoral",    // title
            2016,       // year
            "An All-American college star and his beauty queen wife watch their seemingly perfect life fall apart as their daughter joins the turmoil of '60s America.",     // plot
            6.1      // rating
        );
