...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Lights Out",    // title
            2016,       // year
            "Rebecca must unlock the terror behind her little brother's experiences that once tested her sanity, bringing her face to face with an entity attached to their mother.",     // plot
            6.4      // rating
        );
