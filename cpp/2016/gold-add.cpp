...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Gold",    // title
            2016,       // year
            "Kenny Wells, a prospector desperate for a lucky break, teams up with a similarly eager geologist and sets off on a journey to find gold in the uncharted jungle of Indonesia.",     // plot
            6.7      // rating
        );
