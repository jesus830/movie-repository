...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Everybody Wants Some!!",    // title
            2016,       // year
            "In 1980, a group of college baseball players navigate their way through the freedoms and responsibilities of unsupervised adulthood.",     // plot
            7      // rating
        );
