...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "31",    // title
            2016,       // year
            "Five carnival workers are kidnapped and held hostage in an abandoned, Hell-like compound where they are forced to participate in a violent game, the goal of which is to survive twelve hours against a gang of sadistic clowns.",     // plot
            5.1      // rating
        );
