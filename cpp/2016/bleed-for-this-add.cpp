...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Bleed for This",    // title
            2016,       // year
            "The inspirational story of World Champion Boxer Vinny Pazienza who, after a near fatal car crash which left him not knowing if he'd ever walk again, made one of sport's most incredible comebacks.",     // plot
            6.8      // rating
        );
