...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "The Legend of Tarzan",    // title
            2016,       // year
            "Tarzan, having acclimated to life in London, is called back to his former home in the jungle to investigate the activities at a mining encampment.",     // plot
            6.3      // rating
        );
