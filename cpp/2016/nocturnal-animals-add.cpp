...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Nocturnal Animals",    // title
            2016,       // year
            "A wealthy art gallery owner is haunted by her ex-husband's novel, a violent thriller she interprets as a symbolic revenge tale.",     // plot
            7.5      // rating
        );
