...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "Teenage Mutant Ninja Turtles: Out of the Shadows",    // title
            2016        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Teenage Mutant Ninja Turtles: Out of the Shadows",    // title
                2016,       // year
                "After facing Shredder, who has joined forces with mad scientist Baxter Stockman and henchmen Bebop and Rocksteady to take over the world, the Turtles must confront an even greater nemesis: the notorious Krang.",     // plot
                6      // rating
            );
