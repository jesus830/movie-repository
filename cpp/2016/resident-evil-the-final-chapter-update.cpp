...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "Resident Evil: The Final Chapter",    // title
            2016        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Resident Evil: The Final Chapter",    // title
                2016,       // year
                "Alice returns to where the nightmare began: The Hive in Raccoon City, where the Umbrella Corporation is gathering its forces for a final strike against the only remaining survivors of the apocalypse.",     // plot
                5.6      // rating
            );
