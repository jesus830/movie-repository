...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Kung Fu Panda 3",    // title
            2016,       // year
            "Continuing his 'legendary adventures of awesomeness', Po must face two hugely epic, but different threats: one supernatural and the other a little closer to his home.",     // plot
            7.2      // rating
        );
