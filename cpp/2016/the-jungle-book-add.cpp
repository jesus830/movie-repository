...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            ...
            2016,       // year
            "After a threat from the tiger Shere Khan forces him to flee the jungle, a man-cub named Mowgli embarks on a journey of self discovery with the help of panther, Bagheera, and free spirited bear, Baloo.",     // plot
            7.5      // rating
        );
