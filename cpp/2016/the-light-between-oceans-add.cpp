...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "The Light Between Oceans",    // title
            2016,       // year
            "A lighthouse keeper and his wife living off the coast of Western Australia raise a baby they rescue from a drifting rowing boat.",     // plot
            7.2      // rating
        );
