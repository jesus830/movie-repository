...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Viral",    // title
            2016,       // year
            "Following the outbreak of a virus that wipes out the majority of the human population, a young woman documents her family's new life in quarantine and tries to protect her infected sister.",     // plot
            5.5      // rating
        );
