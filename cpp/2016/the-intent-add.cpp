...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "The Intent",    // title
            2016,       // year
            "Gunz (Dylan Duffus) is thrust into a world of excitement when he joins the TIC crew. The crew, led by the ruthless Hoodz (Scorcher), goes from low level weed peddling to full on armed ... See full summary »",     // plot
            3.5      // rating
        );
