    ...
    
    {
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Hidden Figures",    // title
                2016,       // year
                "The story of a team of female African-American mathematicians who served a vital role in NASA during the early years of the U.S. space program.",     // plot
                7.8      // rating
            );
