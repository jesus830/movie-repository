...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "The Neon Demon",    // title
            2016,       // year
            "When aspiring model Jesse moves to Los Angeles, her youth and vitality are devoured by a group of beauty-obsessed women who will take any means necessary to get what she has.",     // plot
            6.2      // rating
        );
