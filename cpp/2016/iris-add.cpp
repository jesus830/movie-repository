...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Iris",    // title
            2016,       // year
            "Iris, young wife of a businessman, disappears in Paris. Maybe a mechanic with many debts is involved in the strange affair. A really complicated job for the police.",     // plot
            6.1      // rating
        );
