...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "Keeping Up with the Joneses",    // title
            2016        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Keeping Up with the Joneses",    // title
                2016,       // year
                "A suburban couple becomes embroiled in an international espionage plot when they discover that their seemingly perfect new neighbors are government spies.",     // plot
                5.8      // rating
            );
