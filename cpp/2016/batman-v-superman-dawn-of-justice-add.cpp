...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Batman v Superman: Dawn of Justice",    // title
            2016,       // year
            "Fearing that the actions of Superman are left unchecked, Batman takes on the Man of Steel, while the world wrestles with what kind of a hero it really needs.",     // plot
            6.7      // rating
        );
