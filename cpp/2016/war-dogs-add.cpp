...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "War Dogs",    // title
            2016,       // year
            "Based on the true story of two young men, David Packouz and Efraim Diveroli, who won a $300 million contract from the Pentagon to arm America's allies in Afghanistan.",     // plot
            7.1      // rating
        );
