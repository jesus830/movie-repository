...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Miracles from Heaven",    // title
            2016,       // year
            "A young girl suffering from a rare digestive disorder finds herself miraculously cured after surviving a terrible accident.",     // plot
            7      // rating
        );
