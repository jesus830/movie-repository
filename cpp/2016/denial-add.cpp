...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Denial",    // title
            2016,       // year
            "Acclaimed writer and historian Deborah E. Lipstadt must battle for historical truth to prove the Holocaust actually occurred when David Irving, a renowned denier, sues her for libel.",     // plot
            6.6      // rating
        );
