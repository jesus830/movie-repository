...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "The Huntsman: Winter's War",    // title
            2016,       // year
            "Eric and fellow warrior Sara, raised as members of ice Queen Freya's army, try to conceal their forbidden love as they fight to survive the wicked intentions of both Freya and her sister Ravenna.",     // plot
            6.1      // rating
        );
