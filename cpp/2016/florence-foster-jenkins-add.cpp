...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Florence Foster Jenkins",    // title
            2016,       // year
            "The story of Florence Foster Jenkins, a New York heiress who dreamed of becoming an opera singer, despite having a terrible singing voice.",     // plot
            6.9      // rating
        );
