    ...
    
    {
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Love & Friendship",    // title
                2016,       // year
                "Lady Susan Vernon takes up temporary residence at her in-laws' estate and, while there, is determined to be a matchmaker for her daughter Frederica -- and herself too, naturally.",     // plot
                6.5      // rating
            );
