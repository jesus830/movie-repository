...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "A Hologram for the King",    // title
            2016,       // year
            "A failed American sales rep looks to recoup his losses by traveling to Saudi Arabia and selling his company's product to a wealthy monarch.",     // plot
            6.1      // rating
        );
