...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Lowriders",    // title
            2016,       // year
            "A young street artist in East Los Angeles is caught between his father's obsession with lowrider car culture, his ex-felon brother and his need for self-expression.",     // plot
            6.3      // rating
        );
