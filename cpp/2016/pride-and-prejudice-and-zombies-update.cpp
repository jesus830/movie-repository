...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "Pride and Prejudice and Zombies",    // title
            2016        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Pride and Prejudice and Zombies",    // title
                2016,       // year
                "Five sisters in 19th century England must cope with the pressures to marry while protecting themselves from a growing population of zombies.",     // plot
                5.8      // rating
            );
