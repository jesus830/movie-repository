...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "The Autopsy of Jane Doe",    // title
            2016,       // year
            "A father and son, both coroners, are pulled into a complex mystery while attempting to identify the body of a young woman, who was apparently harboring dark secrets.",     // plot
            6.8      // rating
        );
