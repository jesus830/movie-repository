    ...
    
    {
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Folk Hero & Funny Guy",    // title
                2016,       // year
                "A successful singer-songwriter hatches a plan to help his friend's struggling comedy career and broken love life by hiring him as his opening act on his solo tour.",     // plot
                5.6      // rating
            );
