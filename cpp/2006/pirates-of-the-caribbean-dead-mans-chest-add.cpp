...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Pirates of the Caribbean: Dead Man's Chest",    // title
            2006,       // year
            "Jack Sparrow races to recover the heart of Davy Jones to avoid enslaving his soul to Jones' service, as other friends and foes seek the heart for their own agenda as well.",     // plot
            7.3      // rating
        );
