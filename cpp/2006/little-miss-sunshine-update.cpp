    ...
    
    {
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Little Miss Sunshine",    // title
                2006,       // year
                "A family determined to get their young daughter into the finals of a beauty pageant take a cross-country trip in their VW bus.",     // plot
                7.8      // rating
            );
