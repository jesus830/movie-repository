...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "The Fast and the Furious: Tokyo Drift",    // title
            2006,       // year
            "A teenager becomes a major competitor in the world of drift racing after moving in with his father in Tokyo to avoid a jail sentence in America.",     // plot
            6      // rating
        );
