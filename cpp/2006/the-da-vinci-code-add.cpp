...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            ...
            2006,       // year
            "A murder inside the Louvre and clues in Da Vinci paintings lead to the discovery of a religious mystery protected by a secret society for two thousand years -- which could shake the foundations of Christianity.",     // plot
            6.6      // rating
        );
