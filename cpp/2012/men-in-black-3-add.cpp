...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Men in Black 3",    // title
            2012,       // year
            "Agent J travels in time to M.I.B.'s early days in 1969 to stop an alien from assassinating his friend Agent K and changing history.",     // plot
            6.8      // rating
        );
