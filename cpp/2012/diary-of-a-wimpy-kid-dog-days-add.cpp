...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Diary of a Wimpy Kid: Dog Days",    // title
            2012,       // year
            "School's out. Summer vacation is on. However, Greg may not have the best summer vacation ever. What could go wrong?",     // plot
            6.4      // rating
        );
