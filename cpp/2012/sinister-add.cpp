...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Sinister",    // title
            2012,       // year
            "Washed-up true-crime writer Ellison Oswalt finds a box of super 8 home movies that suggest the murder he is currently researching is the work of a serial killer whose work dates back to the 1960s.",     // plot
            6.8      // rating
        );
