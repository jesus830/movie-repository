...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "The Lucky One",    // title
            2012,       // year
            "A Marine travels to Louisiana after serving three tours in Iraq and searches for the unknown woman he believes was his good luck charm during the war.",     // plot
            6.5      // rating
        );
