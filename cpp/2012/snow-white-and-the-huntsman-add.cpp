...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Snow White and the Huntsman",    // title
            2012,       // year
            "In a twist to the fairy tale, the Huntsman ordered to take Snow White into the woods to be killed winds up becoming her protector and mentor in a quest to vanquish the Evil Queen.",     // plot
            6.1      // rating
        );
