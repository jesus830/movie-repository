...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Ted",    // title
            2012,       // year
            "John Bennett, a man whose childhood wish of bringing his teddy bear to life came true, now must decide between keeping the relationship with the bear or his girlfriend, Lori.",     // plot
            7      // rating
        );
