...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Total Recall",    // title
            2012,       // year
            "A factory worker, Douglas Quaid, begins to suspect that he is a spy after visiting Rekall - a company that provides its clients with implanted fake memories of a life they would like to have led - goes wrong and he finds himself on the run.",     // plot
            6.3      // rating
        );
