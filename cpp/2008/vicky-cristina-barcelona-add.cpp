...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Vicky Cristina Barcelona",    // title
            2008,       // year
            "Two girlfriends on a summer holiday in Spain become enamored with the same painter, unaware that his ex-wife, with whom he has a tempestuous relationship, is about to re-enter the picture.",     // plot
            7.1      // rating
        );
