...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Hancock",    // title
            2008,       // year
            "Hancock is a superhero whose ill considered behavior regularly causes damage in the millions. He changes when the person he saves helps him improve his public image.",     // plot
            6.4      // rating
        );
