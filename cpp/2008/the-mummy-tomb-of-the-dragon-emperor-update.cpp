...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "The Mummy: Tomb of the Dragon Emperor",    // title
            2008        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "The Mummy: Tomb of the Dragon Emperor",    // title
                2008,       // year
                "In the Far East, Alex O'Connell, the son of famed mummy fighters Rick and Evy O'Connell, unearths the mummy of the first Emperor of Qin -- a shape-shifting entity cursed by a witch centuries ago.",     // plot
                5.2      // rating
            );
