...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "Forgetting Sarah Marshall",    // title
            2008        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Forgetting Sarah Marshall",    // title
                2008,       // year
                "Devastated Peter takes a Hawaiian vacation in order to deal with the recent break-up with his TV star girlfriend, Sarah. Little does he know, Sarah's traveling to the same resort as her ex - and she's bringing along her new boyfriend.",     // plot
                7.2      // rating
            );
