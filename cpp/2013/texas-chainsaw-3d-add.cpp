...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            ...
            2013,       // year
            "A young woman travels to Texas to collect an inheritance; little does she know that an encounter with a chainsaw-wielding killer is part of the reward.",     // plot
            4.8      // rating
        );
