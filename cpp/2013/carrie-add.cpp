...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Carrie",    // title
            2013,       // year
            "A shy girl, outcasted by her peers and sheltered by her religious mother, unleashes telekinetic terror on her small town after being pushed too far at her senior prom.",     // plot
            5.9      // rating
        );
