    ...
    
    {
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "The Lone Ranger",    // title
                2013,       // year
                "Native American warrior Tonto recounts the untold tales that transformed John Reid, a man of the law, into a legend of justice.",     // plot
                6.5      // rating
            );
