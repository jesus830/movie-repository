...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Closed Circuit",    // title
            2013,       // year
            "A high-profile terrorism case unexpectedly binds together two ex-lovers on the defense team - testing the limits of their loyalties and placing their lives in jeopardy.",     // plot
            6.2      // rating
        );
