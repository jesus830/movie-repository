...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Monsters University",    // title
            2013,       // year
            "A look at the relationship between Mike and Sulley during their days at Monsters University -- when they weren't necessarily the best of friends.",     // plot
            7.3      // rating
        );
