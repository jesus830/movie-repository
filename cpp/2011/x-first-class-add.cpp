...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "X: First Class",    // title
            2011,       // year
            "In 1962, the United States government enlists the help of Mutants with superhuman abilities to stop a malicious dictator who is determined to start World War III.",     // plot
            7.8      // rating
        );
