...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "Transformers: Dark of the Moon",    // title
            2011        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Transformers: Dark of the Moon",    // title
                2011,       // year
                "The Autobots learn of a Cybertronian spacecraft hidden on the moon, and race against the Decepticons to reach it and to learn its secrets.",     // plot
                6.3      // rating
            );
