...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Sherlock Holmes: A Game of Shadows",    // title
            2011,       // year
            "Sherlock Holmes and his sidekick Dr. Watson join forces to outwit and bring down their fiercest adversary, Professor Moriarty.",     // plot
            7.5      // rating
        );
