...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Footloose",    // title
            2011,       // year
            "City teenager Ren MacCormack moves to a small town where rock music and dancing have been banned, and his rebellious spirit shakes up the populace.",     // plot
            5.9      // rating
        );
