...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Endless Love",    // title
            2014,       // year
            "The story of a privileged girl and a charismatic boy whose instant desire sparks a love affair made only more reckless by parents trying to keep them apart.",     // plot
            6.3      // rating
        );
