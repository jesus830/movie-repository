...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "Transformers: Age of Extinction",    // title
            2014        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Transformers: Age of Extinction",    // title
                2014,       // year
                "Autobots must escape sight from a bounty hunter who has taken control of the human serendipity: Unexpectedly, Optimus Prime and his remaining gang turn to a mechanic, his daughter, and her back street racing boyfriend for help.",     // plot
                5.7      // rating
            );
