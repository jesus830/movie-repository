...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "How to Train Your Dragon 2",    // title
            2014        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "How to Train Your Dragon 2",    // title
                2014,       // year
                "When Hiccup and Toothless discover an ice cave that is home to hundreds of new wild dragons and the mysterious Dragon Rider, the two friends find themselves at the center of a battle to protect the peace.",     // plot
                7.9      // rating
            );
