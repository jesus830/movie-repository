...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "Birdman or (The Unexpected Virtue of Ignorance)",    // title
            2014        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Birdman or (The Unexpected Virtue of Ignorance)",    // title
                2014,       // year
                "Illustrated upon the progress of his latest Broadway play, a former popular actor's struggle to cope with his current life as a wasted actor is shown.",     // plot
                7.8      // rating
            );
