...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            ...
            2014,       // year
            "The X-Men send Wolverine to the past in a desperate effort to change history and prevent an event that results in doom for both humans and mutants.",     // plot
            8      // rating
        );
