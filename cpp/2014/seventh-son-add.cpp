...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Seventh Son",    // title
            2014,       // year
            "When Mother Malkin, the queen of evil witches, escapes the pit she was imprisoned in by professional monster hunter Spook decades ago and kills his apprentice, he recruits young Tom, the seventh son of the seventh son, to help him.",     // plot
            5.5      // rating
        );
