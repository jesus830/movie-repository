...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "Night at the Museum: Secret of the Tomb",    // title
            2014        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Night at the Museum: Secret of the Tomb",    // title
                2014,       // year
                "Larry spans the globe, uniting favorite and new characters while embarking on an epic quest to save the magic before it is gone forever.",     // plot
                6.2      // rating
            );
