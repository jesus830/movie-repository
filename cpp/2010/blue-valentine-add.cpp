...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Blue Valentine",    // title
            2010,       // year
            "The relationship of a contemporary married couple, charting their evolution over a span of years by cross-cutting between time periods.",     // plot
            7.4      // rating
        );
