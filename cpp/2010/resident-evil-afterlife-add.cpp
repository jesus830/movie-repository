...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Resident Evil: Afterlife",    // title
            2010,       // year
            "While still out to destroy the evil Umbrella Corporation, Alice joins a group of survivors living in a prison surrounded by the infected who also want to relocate to the mysterious but supposedly unharmed safe haven known only as Arcadia.",     // plot
            5.9      // rating
        );
