...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "The Twilight Saga: Eclipse",    // title
            2010,       // year
            "As a string of mysterious killings grips Seattle, Bella, whose high school graduation is fast approaching, is forced to choose between her love for vampire Edward and her friendship with werewolf Jacob.",     // plot
            4.9      // rating
        );
