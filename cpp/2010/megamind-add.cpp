...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Megamind",    // title
            2010,       // year
            "The supervillain Megamind finally defeats his nemesis, the superhero Metro Man. But without a hero, he loses all purpose and must find new meaning to his life.",     // plot
            7.3      // rating
        );
