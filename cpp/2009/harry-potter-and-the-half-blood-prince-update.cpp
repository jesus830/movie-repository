...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "Harry Potter and the Half-Blood Prince",    // title
            2009        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Harry Potter and the Half-Blood Prince",    // title
                2009,       // year
                "As Harry Potter begins his sixth year at Hogwarts, he discovers an old book marked as 'the property of the Half-Blood Prince' and begins to learn more about Lord Voldemort's dark past.",     // plot
                7.5      // rating
            );
