...
int main()
{
    ...
    
    {
        ...
        auto movie = movies.Select(
            "Underworld: Rise of the Lycans",    // title
            2009        // year
        );
        ...
        if (movie.has_value()) {
            ...
            bool success = movies.Update(
                "Underworld: Rise of the Lycans",    // title
                2009,       // year
                "An origins story centered on the centuries-old feud between the race of aristocratic vampires and their onetime slaves, the Lycans.",     // plot
                6.6      // rating
            );
