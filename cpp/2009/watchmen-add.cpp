...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Watchmen",    // title
            2009,       // year
            "In 1985 where former superheroes exist, the murder of a colleague sends active vigilante Rorschach into his own sprawling investigation, uncovering something that could completely change the course of history as we know it.",     // plot
            7.6      // rating
        );
