...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Public Enemies",    // title
            2009,       // year
            "The Feds try to take down notorious American gangsters John Dillinger, Baby Face Nelson and Pretty Boy Floyd during a booming crime wave in the 1930s.",     // plot
            7      // rating
        );
