...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "El secreto de sus ojos",    // title
            2009,       // year
            "A retired legal counselor writes a novel hoping to find closure for one of his past unresolved homicide cases and for his unreciprocated love with his superior - both of which still haunt him decades later.",     // plot
            8.2      // rating
        );
