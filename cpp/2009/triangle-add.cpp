...
int main()
{
    ...
    
    {
        ...
        bool success = movies.Insert(
            "Triangle",    // title
            2009,       // year
            "The story revolves around the passengers of a yachting trip in the Atlantic Ocean who, when struck by mysterious weather conditions, jump to another ship only to experience greater havoc on the open seas.",     // plot
            6.9      // rating
        );
